    ...
    <div className="studio-grid-bg min-h-[calc(100dvh-3.5rem)]">
      <div className="mx-auto flex w-full max-w-lg flex-col justify-center px-[var(--space-page-x)] py-[var(--space-page-y)]">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-fluid-2xl font-bold tracking-tight sm:text-fluid-3xl">Start a live session</h1>
          <p className="mt-2 text-fluid-sm text-muted-foreground sm:text-fluid-base">
